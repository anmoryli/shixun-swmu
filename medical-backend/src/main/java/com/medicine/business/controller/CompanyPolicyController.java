...
import com.medicine.business.service.CompanyPolicyService;
...
public class CompanyPolicyController {
    ...
    public CompanyPolicyController(CompanyPolicyService service) {
    ...
    public ApiResponse<Map<String, Object>> page(@RequestParam(defaultValue = "1") Integer pn,
        ...
        return BusinessResponses.wrapped("policyInfo", service.page(pn, size, keyword));
    }
